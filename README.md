...
Links must use stable anchors such as `tk0001`, `rp0001`, `tk0001.rv001-r1-codex`, or `tk0001.s01-repro`; never link stateful full filenames such as `tk0001.tdo.*.md`.
